...
$infolist_directory=array(
  "leisure_sport_tourism"=>array(
    ...
    "leisure"=>array(
      "sports_centre"=>array("type"=>"leisure", "subtype"=>"sport"),
      "golf_course"=>array("type"=>"leisure"),
      "stadium"=>array("type"=>"leisure", "subtype"=>"sport"),
      "track"=>array("type"=>"leisure", "subtype"=>"sport"),
      "pitch"=>array("type"=>"leisure", "subtype"=>"sport"),
      "water_park"=>array("type"=>"leisure"),
      "marina"=>array("type"=>"leisure"),
      "slipway"=>array("type"=>"leisure"),
      "fishing"=>array("type"=>"leisure"),
      "nature_reserve"=>array("type"=>"leisure"),
      "park"=>array("type"=>"leisure"),
      "playground"=>array("type"=>"leisure", "subtype"=>"sport"),
      "garden"=>array("type"=>"leisure"),
      "common"=>array("type"=>"leisure"),
      "ice_rink"=>array("type"=>"leisure", "subtype"=>"sport"),
      "miniature_golf"=>array("type"=>"leisure"),
      "swimming_pool"=>array("type"=>"leisure", "subtype"=>"sport"),
      "beach_resort"=>array("type"=>"leisure", "subtype"=>"sport"),
      "bird_hide"=>array("type"=>"leisure"),
      "sport"=>array("type"=>"leisure", "subtype"=>"sport"),
    ),
    "sport"=>array(
      "9pin"=>array("type"=>"sport"),
      "10pin"=>array("type"=>"sport"),
      "archery"=>array("type"=>"sport"),
      "athletics"=>array("type"=>"sport"),
      "australian_football"=>array("type"=>"sport"),
      "baseball"=>array("type"=>"sport"),
      "basketball"=>array("type"=>"sport"),
      "beachvolleyball"=>array("type"=>"sport"),
      "boules"=>array("type"=>"sport"),
      "bowls"=>array("type"=>"sport"),
      "canoe"=>array("type"=>"sport"),
      "chess"=>array("type"=>"sport"),
      "climbing"=>array("type"=>"sport"),
      "cricket"=>array("type"=>"sport"),
      "cricket_nets"=>array("type"=>"sport"),
      "croquet"=>array("type"=>"sport"),
      "cycling"=>array("type"=>"sport"),
      "diving"=>array("type"=>"sport"),
      "dog_racing"=>array("type"=>"sport"),
      "equestrian"=>array("type"=>"sport"),
      "football"=>array("type"=>"sport"),
      "golf"=>array("type"=>"sport"),
      "gymnastics"=>array("type"=>"sport"),
      "hockey"=>array("type"=>"sport"),
      "horse_racing"=>array("type"=>"sport"),
      "korfball"=>array("type"=>"sport"),
      "motor"=>array("type"=>"sport"),
      "multi"=>array("type"=>"sport"),
      "orienteering"=>array("type"=>"sport"),
      "paddle_tennis"=>array("type"=>"sport"),
      "paragliding"=>array("type"=>"sport"),
      "pelota"=>array("type"=>"sport"),
      "racquet"=>array("type"=>"sport"),
      "rowing"=>array("type"=>"sport"),
      "rugby"=>array("type"=>"sport"),
      "shooting"=>array("type"=>"sport"),
      "skating"=>array("type"=>"sport"),
      "skateboard"=>array("type"=>"sport"),
      "skiing"=>array("type"=>"sport"),
      "soccer"=>array("type"=>"sport"),
      "swimming"=>array("type"=>"sport"),
      "table_tennis"=>array("type"=>"sport"),
      "team_handball"=>array("type"=>"sport"),
      "tennis"=>array("type"=>"sport"),
      "volleyball"=>array("type"=>"sport"),
      ),
    "cycle_hiking"=>array(
