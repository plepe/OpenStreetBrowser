...
// addr:housename
$lang_str["tag:addr:housename"]="Nom de maison";

// addr:street
$lang_str["tag:addr:street"]="Rue";

// addr:postcode
$lang_str["tag:addr:postcode"]="Code postal";

// addr:city
$lang_str["tag:addr:city"]="Ville";

// addr:country
$lang_str["tag:addr:country"]="Pays";

// addr:full
$lang_str["tag:addr:full"]="Adresse complète";

// addr:interpolation
$lang_str["tag:addr:interpolation"]="Interpolation de l'adresse";

// aeroway
$lang_str["tag:aeroway"]="Aéroport";
$lang_str["tag:aeroway=runway"]="Piste d'aterrissage";
...
$lang_str["tag:admin_level=4"]="Limites d'État / Province / Lander";
$lang_str["tag:admin_level=5"]="Limites de Régions administratives";
$lang_str["tag:admin_level=6"]="Limites des MRC (Québec)";
$lang_str["tag:admin_level=8"]="Limites de Communes";
$lang_str["tag:admin_level=10"]="Limites d'Arrondissements municipaux";
$lang_str["tag:admin_level=7"]="Limites de Comtés";
$lang_str["tag:admin_level=7.5"]="Limites d'Agglomérations urbaines";
...
$lang_str["tag:amenity=pub"]=array("Pub/Brasserie", "Pubs/Brasseries");

// barrier
$lang_str["tag:barrier"]=array("Barrière", "Barrières");
$lang_str["tag:barrier=city_wall"]=array("Mur de la ville", "Murs de la ville");
...
$lang_str["tag:highway=road"]="Route générique";
...
$lang_str["tag:highway=steps"]="Escalier";

// bridge
$lang_str["tag:bridge"]="Pont";

// tunnel
$lang_str["tag:tunnel"]="Tunnel";

// traffic_calming
$lang_str["tag:traffic_calming"]="Ralentisseur";

// service
#$lang_str["tag:service"]="Service road attributes";

// postal_code
$lang_str["tag:postal_code"]="Code postal";

// is_in
$lang_str["tag:is_in"]="Est situé en/dans";

// leisure
$lang_str["tag:leisure"]="Loisir";
...
$lang_str["tag:leisure=pitch"]="Terrain de sports";
...
$lang_str["tag:leisure=swimming_pool"]="Piscine";
...
// name
$lang_str["tag:name"]=array("Nom", "Noms");

// alt_name
$lang_str["tag:alt_name"]=array("Autre appellation", "Autres appellations");

// official_name
$lang_str["tag:official_name"]=array("Nom officiel", "Noms offiiciels");

// int_name
$lang_str["tag:int_name"]="Nom international";

// loc_name
$lang_str["tag:loc_name"]="Appellation locale";

// old_name
$lang_str["tag:old_name"]="Ancien nom(s)";

// ref
$lang_str["tag:ref"]="Référence";
...
$lang_str["tag:place=city"]="Ville";
$lang_str["tag:place=town"]="Commune";
$lang_str["tag:place=village"]="Village";
$lang_str["tag:place=suburb"]="Quartier";
$lang_str["tag:place=hamlet"]="Hameau";
$lang_str["tag:place=locality"]="Lieu-dit non habité";
$lang_str["tag:place=island"]="Île";
$lang_str["tag:place=islet"]="Îlot";
$lang_str["tag:place=ocean"]="Océan";
$lang_str["tag:place=sea"]="Mer";
...
$lang_str["tag:power_source=waste"]="Déchets";
$lang_str["tag:power_source=hydro"]="Hydrolique";
...
$lang_str["tag:power_source=photovoltaic"]="Solaire (électrique)";
$lang_str["tag:power_source=solar-thermal"]="Solaire (thermique)";
...
$lang_str["tag:railway=platform"]=array("Quai", "Quais");
...
$lang_str["tag:religion=multifaith"]="multiconfessionnel";

// denomination
$lang_str["tag:denomination"]="Confession/Forme";
...
$lang_str["tag:route=subway"]="Métro";
...
$lang_str["tag:sport=equestrian"]="Sport équestre";
...
$lang_str["tag:sport=motor"]="Sports mécaniques";
$lang_str["tag:sport=multi"]="Multi-sport";
$lang_str["tag:sport=orienteering"]="Course d'orientation";
$lang_str["tag:sport=paddle_tennis"]="Paddle Tennis";
$lang_str["tag:sport=paragliding"]="Paragliding";
$lang_str["tag:sport=pelota"]="Pelote Basque";
...
$lang_str["tag:sport=soccer"]="Football";
...
// vending
$lang_str["tag:vending"]="Distributeur automatique";
