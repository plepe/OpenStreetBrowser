...
$lang_str["user:create_user"]="Crear un nou usuari:";
$lang_str["user:username"]="Nom d'usari";
$lang_str["user:email"]="Adreça de correu electrònic";
$lang_str["user:password"]="Contrasenya";
$lang_str["user:password_verify"]="Verificar contrasenya";
$lang_str["user:old_password"]="Contrasenya antiga";
$lang_str["user:no_username"]="Si us plau, especifiqui un nom d'usuari!";
#$lang_str["user:password_no_match"]="Passwords do not match!";
$lang_str["user:full_name"]="Nom complet";
$lang_str["user:user_exists"]="L'usuari ja existeix";
$lang_str["user:login"]="Iniciar una sessió";
$lang_str["user:logged_in_as"]="Identificat com a";
$lang_str["user:logout"]="Finalitzar la sessió";
...
$lang_str["more_categories"]="Més categories";
