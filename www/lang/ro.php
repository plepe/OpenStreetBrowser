...
$lang_str["user:no_auth"]="Nume sau parola incorecta!";
#$lang_str["user:login_text"]="Log in to OpenStreetBrowser:";
$lang_str["user:create_user"]="Creeaza un user nou :";
...
$lang_str["user:user_exists"]="Username exista deja";
