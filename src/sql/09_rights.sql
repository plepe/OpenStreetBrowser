...
grant all on ways to www;
grant all on way_tags to www;
grant all on way_nodes to www;
grant all on relations to www;
grant all on relation_tags to www;
grant all on relation_members to www;
grant all on coll_tags to www;
grant all on coll_members to www;
