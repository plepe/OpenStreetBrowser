...
update planet_osm_boundaries set place_id=member_id, rel_id=relation_id from relation_members where member_role='label' and member_type='1' and rel_id=relation_id;
...
insert into coll_members select osm_id, osm_id, 1, 'label' from planet_osm_boundaries join planet_osm_point on planet_osm_boundaries.place_id=planet_osm_point.osm_id;
insert into coll_members select osm_id, rel_id, 3, '' from planet_osm_boundaries join planet_osm_point on planet_osm_boundaries.place_id=planet_osm_point.osm_id;
...
insert into planet_osm_boundaries_only select osm_id, cast(admin_level as int), way from planet_osm_roads where "boundary"='administrative' and osm_id>0 and admin_level similar to '^[0-9]+$';
