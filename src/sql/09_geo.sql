...
insert into geo select member_id, 'way', way from planet_osm_polygon join relation_members on relation_id=-osm_id and member_type='W' and member_role='outer' where osm_id<0;
