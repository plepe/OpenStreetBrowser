...
update planet_osm_rels set name=(select v from relation_tags where relation_tags.relation_id=planet_osm_rels.id and k='name');

alter table planet_osm_rels add column route text;
update planet_osm_rels set route=(select v from relation_tags where relation_tags.relation_id=planet_osm_rels.id and k='route');

alter table planet_osm_rels add column type text;
update planet_osm_rels set type=(select v from relation_tags where relation_tags.relation_id=planet_osm_rels.id and k='type');

alter table planet_osm_rels add column ref text;
update planet_osm_rels set ref=(select v from relation_tags where relation_tags.relation_id=planet_osm_rels.id and k='ref');

alter table planet_osm_rels add column network text;
update planet_osm_rels set network=(select v from relation_tags where relation_tags.relation_id=planet_osm_rels.id and k='network');

alter table planet_osm_rels add column importance text;
update planet_osm_rels set importance=(select v from relation_tags where relation_tags.relation_id=planet_osm_rels.id and k='importance');

alter table planet_osm_rels add column admin_level text;
update planet_osm_rels set admin_level=(select v from relation_tags where relation_tags.relation_id=planet_osm_rels.id and k='admin_level');

alter table planet_osm_rels add column boundary text;
update planet_osm_rels set boundary=(select v from relation_tags where relation_tags.relation_id=planet_osm_rels.id and k='boundary');
