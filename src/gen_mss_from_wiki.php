 ...
 //print_r($values_list);
  ...
  foreach($values_list as $values_data) {
	...
	$style_icon.="  </Rule>\n";
      ...
      $style_text.="    <TextSymbolizer dy=\"".ceil($imgsize[1]/2+11)."\" vertical_alignment=\"top\" face_name=\"DejaVu Sans Book\" fill=\"#000000\" name=\"name\" placement=\"point\" size=\"10\"";
      if($category_data["bg-color"])
        $style_text.=" halo_fill=\"{$category_data["bg-color"]}\" halo_radius=\"1\"";
      $style_text.="/>\n";
      $style_text.="    <TextSymbolizer dy=\"".ceil($imgsize[1]/2+10+11)."\" vertical_alignment=\"top\" face_name=\"DejaVu Sans Book\" fill=\"#000000\" name=\"desc\" placement=\"point\" size=\"8\"";
      if($category_data["bg-color"])
        $style_text.=" halo_fill=\"{$category_data["bg-color"]}\" halo_radius=\"1\"";
      $style_text.="/>\n";
      $style_text.="  </Rule>\n";
