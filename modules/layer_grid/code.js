...
var layer_grid_meridian_major_label_style={ labelAlign: 'ct', labelYOffset: -4, labelOutlineWidth: 1, labelOutlineColor: 'white', externalGraphic: modulekit_file("layer_grid", "background.png"), graphicHeight: 14, graphicWidth: 40, graphicYOffset: 1, graphicOpacity: 0.75, fontFamily: "Tahoma, Arial, Verdana", fontWeight: "bold", fontSize: "11px" };
var layer_grid_latitude_major_label_style={ labelAlign: 'rm', labelXOffset: -4, labelOutlineWidth: 1, labelOutlineColor: 'white', externalGraphic: modulekit_file("layer_grid", "background.png"), graphicHeight: 14, graphicWidth: 40, graphicXOffset: -41, graphicOpacity: 0.75, fontFamily: "Tahoma, Arial, Verdana", fontWeight: "bold", fontSize: "11px" };
var layer_grid_meridian_minor_label_style={ labelAlign: 'ct', labelYOffset: -4, labelOutlineWidth: 1, labelOutlineColor: 'white', externalGraphic: modulekit_file("layer_grid", "background.png"), graphicHeight: 14, graphicWidth: 40, graphicYOffset: 1, graphicOpacity: 0.6, fontFamily: "Tahoma, Arial, Verdana", fontWeight: "normal", fontSize: "11px" };
var layer_grid_latitude_minor_label_style={ labelAlign: 'rm', labelXOffset: -4, labelOutlineWidth: 1, labelOutlineColor: 'white', externalGraphic: modulekit_file("layer_grid", "background.png"), graphicHeight: 14, graphicWidth: 40, graphicXOffset: -41, graphicOpacity: 0.6, fontFamily: "Tahoma, Arial, Verdana", fontWeight: "normal", fontSize: "11px" };
