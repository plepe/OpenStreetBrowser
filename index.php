...
if(!file_exists("lib/ol3/ol.js")) {
  print "Please download <a href='http://openlayers.org/'>OpenLayers</a> and extract to lib/ol3/ (so that lib/ol3/ol.js exists)\n";
  exit();
}
?>
<!DOCTYPE HTML>
...
<script src="lib/ol3/ol.js<?=$version_string?>"></script>
