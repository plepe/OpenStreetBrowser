...
// addr:housenumber
$lang_str["tag:addr:housenumber"]="Numar casa";
...
// amenity
$lang_str["tag:amenity"]="Atractie";
$lang_str["tag:amenity=cinema"]="Cinema";
$lang_str["tag:amenity=restaurant"]="Restaurant";
$lang_str["tag:amenity=pub"]="Pub";
...
// cables
$lang_str["tag:cables"]="Cabluri";

// description
$lang_str["tag:description"]="Descriere";

// fixme
$lang_str["tag:fixme"]="Corecteaza";

// note
$lang_str["tag:note"]="Notita";
...
$lang_str["tag:highway=primary"]="Drum principal";
#$lang_str["tag:highway=primary_link"]="Primary Road Link";
$lang_str["tag:highway=secondary"]="Drum secundar";
$lang_str["tag:highway=tertiary"]="Drum tertiar";
$lang_str["tag:highway=minor"]="Drum mic";
$lang_str["tag:highway=road"]="Drum";
$lang_str["tag:highway=residential"]="Drum rezidential";
$lang_str["tag:highway=unclassified"]="Drum neclasificat";
$lang_str["tag:highway=service"]="Drum service";
$lang_str["tag:highway=pedestrian"]="Zona pietonala";
...
$lang_str["tag:highway=steps"]="Trepte";

// bridge
$lang_str["tag:bridge"]="Pod";
...
// postal_code
$lang_str["tag:postal_code"]="Cod postal";

// is_in
$lang_str["tag:is_in"]="este in";
...
$lang_str["tag:leisure=playground"]="Teren de joaca";
$lang_str["tag:leisure=garden"]="Parc";
...
// type
$lang_str["tag:type"]="Model";
$lang_str["tag:type=gas"]="Peco";
#$lang_str["tag:type=heat"]="Heat";
$lang_str["tag:type=hot_water"]="Apa calda";
$lang_str["tag:type=oil"]="Ulei";
#$lang_str["tag:type=sewage"]="Sewage";
$lang_str["tag:type=water"]="Apa";

// name
$lang_str["tag:name"]="Nume";

// alt_name
$lang_str["tag:alt_name"]="Nume alternativ";

// official_name
$lang_str["tag:official_name"]="Nume oficial";

// int_name
$lang_str["tag:int_name"]="Nume international";

// loc_name
$lang_str["tag:loc_name"]="Nume local";

// old_name
$lang_str["tag:old_name"]="Nume vechi";
...
$lang_str["tag:place=state"]="Stat";
$lang_str["tag:place=region"]="Regiune";
#$lang_str["tag:place=county"]=array("County", "Counties");
$lang_str["tag:place=city"]="Oras";
...
$lang_str["tag:place=locality"]="Localitate";
$lang_str["tag:place=island"]="Insula";
#$lang_str["tag:place=islet"]=array("Islet", "Islets");
$lang_str["tag:place=ocean"]="Ocean";
$lang_str["tag:place=sea"]="Mare";
...
$lang_str["tag:power=line"]="Linie energie";
...
$lang_str["tag:religion=christian"]="Crestina";
...
$lang_str["tag:route=railway"]="Cale ferata ";
$lang_str["tag:route=rail"]="Cale ferata ";
#$lang_str["tag:route=light_rail"]="Light Rail";
$lang_str["tag:route=subway"]="Metrou";
$lang_str["tag:route=tram"]="Tramvai";
$lang_str["tag:route=tram_bus"]="Tramvai si autobuz";
$lang_str["tag:route=trolley"]="Troleu";
$lang_str["tag:route=trolleybus"]="Troleu";
$lang_str["tag:route=bus"]="Autobuz";
...
$lang_str["tag:sport=football"]="Fotbal";
...
// emergency
$lang_str["tag:emergency"]="Urgenta";

// tourism
$lang_str["tag:tourism"]="Turism";

// historic
$lang_str["tag:historic"]="Istoric";
...
// oneway
$lang_str["tag:oneway"]="Un singur sens";

// noexit
$lang_str["tag:noexit"]="Sfarsit de drum";

// maxweight
$lang_str["tag:maxweight"]="Greutate maxima";

// maxheight
$lang_str["tag:maxheight"]="Inaltime maxima";

// maxlength
$lang_str["tag:maxlength"]="Lungime maxima";

// maxspeed
$lang_str["tag:maxspeed"]="Viteza maxima";

// minspeed
$lang_str["tag:minspeed"]="Viteza minima";
...
// created_by
$lang_str["tag:created_by"]="Creeat de ";
