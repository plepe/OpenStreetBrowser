<?
// General
$lang_str["general_info"]=array(F, "Informação Geral");
$lang_str["yes"]="Sim";
$lang_str["no"]="Não";
$lang_str["ok"]="OK";
$lang_str["save"]="Salvar";
$lang_str["saved"]="Salvo"; // for dialog boxes confirming saving
$lang_str["cancel"]="Cancelar";
$lang_str["show"]="Mostrar";
$lang_str["edit"]="Editar";
$lang_str["delete"]="Deletar";
$lang_str["history"]=array(M, "Histórico");
$lang_str["choose"]="Escolher";
$lang_str["help"]=array(F, "Ajuda");
$lang_str["longitude"]=array(F, "Longitude", "Longitudes");
$lang_str["latitude"]=array(F, "Latitude", "Latitudes");
$lang_str["noname"]="(semnome)";
#$lang_str["info_back"]="back to overview";
$lang_str["info_zoom"]="Zoom";
$lang_str["nothing_found"]="Nada encontrado";
#$lang_str["list:zoom_for_obs"]="Zoom in for less important objects";
$lang_str["loading"]="Carregando";
$lang_str["more"]="mais";
$lang_str["source"]=array(F, "Fonte");
$lang_str["unnamed"]="sem nome";
$lang_str["zoom"]=array(M, "Nível de Zoom");
$lang_str["no_message"]=array("sem mensagem", "sem mensagens");
$lang_str["ad"]=array(F, "Propaganda", "Propagandas");
